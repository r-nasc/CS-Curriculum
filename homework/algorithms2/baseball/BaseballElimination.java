...
public class BaseballElimination {
    ...
    public int against(String team1, String team2) {
        if (team1 == null || team2 == null)
            throw new IllegalArgumentException("team is invalid");
        if (teamToIndex.get(team1) == null || teamToIndex.get(team2) == null)
            throw new IllegalArgumentException("team is invalid");
    ...
    // models the nontrivial elimination of a team as a flow network
    ...
    // Check that all edges from source are full
    private boolean isSourceFull(FlowNetwork fn, int s) {
    ...
    private void updateEliminated(String team) {
